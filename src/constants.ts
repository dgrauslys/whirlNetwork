...
// Padding
export const basePadding = '80px';
export const baseSmallPadding = '20px';

export const minimumDesktopSize = 750;
//export const desktopWidth = '80%';
export const desktopWidth = '100%';
export const mobileWidth = '100%';
...
export const controllersBaseUrl = isDev ? 'http://localhost/whirlNetwork/data/controllers/' : 'https://www.dawngrauslys.com/data/controllers/';